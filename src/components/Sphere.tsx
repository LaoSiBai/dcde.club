...
export default function Sphere() {
    ...
    const createCards = (projects: Project[]) => {
        ...
        list.forEach((p, i) => {
            ...
            const r = state.current.radius; // Initial radius
    ...
    const enterFocus = (p: Project, originalCard: HTMLDivElement) => {
        ...
        (clone as any).originalCard = originalCard;
    ...
    const exitFocus = () => {
        ...
        if (focusedCardCloneRef.current) {
            ...
            const original = (clone as any).originalCard as HTMLElement;
    ...
    const renderSphere = () => {
        ...
        cardsRef.current.forEach(card => {
            ...
            let x2 = x1; // No rotation around Z
